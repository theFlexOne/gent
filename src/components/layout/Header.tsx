...
export default function Header() {
  return (
    <div className="h-20 bg-stone-950 absolute w-full top-6 flex items-center z-50 px-12">
      ...
      <nav className="flex-1 uppercase h-full flex whitespace-nowrap">
        <ul className="flex flex-1 h-full">
          <div className="flex-1 flex h-full justify-around font-[Lucinda] tracking-widest text-sm">
